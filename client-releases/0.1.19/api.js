...
export const api = {
  ...
  // File upload — raw body POST. Returns { id, url, filename, mime, size }.
  // The server wants Content-Type: <mime> and X-Klar-Filename: <name>.
  // onProgress (optional) receives a number 0..1.
