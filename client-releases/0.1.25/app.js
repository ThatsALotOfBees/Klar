...
class CallManager {
  ...
  async _buildPeer() {
    ...
    // ICE-failure timeout: if the connection hasn't reached 'connected'
    // within 25 seconds of buildPeer, abort with a useful error instead
    // of silently sitting on "Connecting…". Most NAT setups establish
    // within 5s; >25s almost always means TURN couldn't punch through.
